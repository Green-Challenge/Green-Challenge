...
public interface MovementLogRepository extends JpaRepository<MovementLog, Long> {
    ...
    List<Optional<MovementLog>> findByDayGreaterThanAndDayLessThanEqualAndAndTransportationAndUser(LocalDate start, LocalDate end, String transportation, User user);
}
